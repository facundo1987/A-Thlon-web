...
const translations = {
  ...
  'Encargado del Área de Nutrición': 'Head of Nutrition',
  'Cuenta con más de dos años de experiencia en atención nutricional, descenso de peso y recomposición corporal': 'He has more than two years of experience in nutrition counseling, weight loss and body recomposition',
  'Su trabajo se orienta también al rendimiento en deportes de fuerza, resistencia, potencia y velocidad, incluyendo atletas híbridos. Se destaca por diseñar estrategias personalizadas, prácticas y sostenibles, adaptadas a los objetivos y la realidad de cada persona': 'His work also focuses on performance in strength, endurance, power and speed sports, including hybrid athletes. He specializes in designing personalized, practical and sustainable strategies adapted to each person’s goals and circumstances',
